...
def blink():
    toggle_eyes()
    root.after(250, toggle_eyes)  # wait 250 miliseconds then open blink again
    root.after(3000, blink)  # wait 3000 milisecond then blink again
